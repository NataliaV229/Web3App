    ...
    <main className={`min-h-screen w-full`} style={backgroundImageStyle}>
      ...
      <div className="bg-black/50 backdrop-blur-md w-full  rounded-lg border px-5 py-4 transition-colors border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30">
        ...
        <p className={`m-0 w-full text-sm opacity-50`}>
          Dental implant surgery is not complicated or dangerous Some people may
          think that because dental implant surgery involves implanting a
          ...
          restoring a person's natural ability to bite and chew, dental implants
          restore the ability to maintain a healthy diet. A study recently found
          that people who had lost five or more teeth by the time they turned 65
          ran a higher risk of diabetes, osteoporosis and heart disease. Dental
          implants can do more than just boost a person's confidence or give
          them a bright, beautiful smile. Dental implants can actually help
          preserve and maintain health and a youthful appearance. Contact our
